...
1. **MongoDB** – Run MongoDB locally or use [MongoDB Atlas](https://www.mongodb.com/cloud/atlas) and put the connection string in `.env`:
   ```
   MONGODB_URI=mongodb://127.0.0.1:27017/club-activity-manager
   ```
